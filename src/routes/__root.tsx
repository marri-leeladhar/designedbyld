...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Leeladhar Marri — Graphic Designer, Visual Storyteller & Creative Technologist based in Vijayawada, India. Crafting visual experiences that connect, inspire, and convert." },
      { name: "author", content: "Leeladhar Marri" },
      { name: "keywords", content: "Graphic Designer Vijayawada, Graphic Designer India, Freelance Graphic Designer, Brand Designer, Social Media Designer, Visual Storyteller" },
      { property: "og:title", content: "Leeladhar Marri — Graphic Designer & Visual Storyteller" },
      { property: "og:description", content: "Crafting visual experiences that connect, inspire, and convert." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "/" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Leeladhar Marri — Graphic Designer" },
