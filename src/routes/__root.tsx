...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of designedby.ld — Graphic Designer, Visual Storyteller & Creative Technologist based in India. Crafting visual experiences that connect, inspire, and convert." },
      { name: "author", content: "designedby.ld" },
      ...
      { property: "og:title", content: "designedby.ld — Graphic Designer & Visual Storyteller" },
      { property: "og:description", content: "Crafting visual experiences that connect, inspire, and convert." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "/" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "designedby.ld — Graphic Designer" },
