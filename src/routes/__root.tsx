...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of DESIGNEDBYLD — Graphic Designer, Visual Storyteller & Creative Technologist based in Vijayawada, India. Crafting visual experiences that connect, inspire, and convert." },
